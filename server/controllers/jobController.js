...
const createJob = async (req, res) => {
    try{
        ...
        // Basic Validation
        if(!companyName || !title || !description || !category || !country || !city || !location || !fixedSalary){
...
const getAllJobs = async (req, res) => {
    try{
        ...
        console.log("Fetched Jobs sucessfully", jobs);
...
const getJobById = async (req, res) => {
    try {
        ...
        console.log("Job fetched sucessfully", job);
...
const getEmployerJobs = async (req, res) => {
    try{
        ...
        console.log("Jobs fetched sucessfully", jobs);
        res.status(200).json(jobs);
    } catch(error){
...
const updateJob = async (req, res) => {
    try{
        ...
        console.log("Job updated sucessfully", updatedJob);
        res.status(200).json({
